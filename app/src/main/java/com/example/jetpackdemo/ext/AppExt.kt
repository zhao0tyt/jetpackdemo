    ...
    activity?.let {
        MaterialDialog(it)
            ...
            .show {
                ...
                getActionButton(WhichButton.POSITIVE).updateTextColor(resources.getColor(R.color.colorPrimary))
                getActionButton(WhichButton.NEGATIVE).updateTextColor(resources.getColor(R.color.colorPrimary))
            }
    }
}
